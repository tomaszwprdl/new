...
const SurferTransition = dynamic(() => import('@/components/SurferTransition'));
const SunsetCard = dynamic(() => import('./SunsetCard'));
...
const ClientPage: React.FC = () => {
  ...
  useEffect(() => {
    if (isMobile) {
      // On mobile, skip entry animation and white screen after 1 second
  ...
  if (isMobile) {
    // On mobile, skip entry animation and white screen
    return (
      <>
        <Header />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 mt-12 md:mt-20">
                  ...
                  >
                    ...
                    <div className="pt-6">
                      <h3 className="text-2xl font-bold text-yellow-700 mb-3">
                        {language === 'pl' ? 'Lokalna Obsługa' : 'Local Service'}
                      </h3>
                      <p className="text-base text-gray-600">
                        {language === 'pl' ? 'Znamy region jak własną kieszeń i zawsze służymy pomocą.' : 'Our team knows the region inside out and is always ready to help.'}
                      </p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="pt-6">
                      <h3 className="text-2xl font-bold text-green-700 mb-3">
                        {language === 'pl' ? 'Brak Ukrytych Opłat' : 'No Hidden Fees'}
                      </h3>
                      <p className="text-base text-gray-600">
                        {language === 'pl' ? 'Przejrzyste ceny—płacisz za to co widzisz' : 'Transparent pricing—what you see is what you pay.'}
                      </p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="pt-6">
                      ...
                      <p className="text-base text-gray-600">
                        {language === 'pl' ? 'Dostarczymy auto tam, gdzie tego potrzebujesz' : "We'll bring your car to you, wherever you are."}
                      </p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="pt-6">
                      <h3 className="text-2xl font-bold text-pink-700 mb-3">
                        {language === 'pl' ? 'Wsparcie 24/7' : '24/7 Support'}
                      </h3>
                      <p className="text-base text-gray-600">
                        {language === 'pl' ? 'Jesteśmy do Twojej dyspozycji o każdej porze.' : 'Day or night, we&apos;re here for you.'}
                      </p>
                    </div>
                  </motion.div>
                </div>
          ...
          <div id="destinations" className="w-full flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12 my-16" style={{ background: 'linear-gradient(180deg, #7DD3FC 0%, #38BDF8 60%, #FDE68A 100%)' }}>
            ...
            <div className="flex-1 w-full">
              <ImageCarousel images={[
                {
                  src: "/images/places/isla de Tabarca.webp",
                ...
                {
                  src: "/images/places/Sierra Espuńa Mrcia.webp",
                ...
                {
                  src: "/images/places/Castillo-de-Santa-Barbara.webp",
                ...
                {
                  src: "/images/places/Santa_Pola.webp",
                ...
                {
                  src: "/images/places/Sierra Espuńa debera ampillar.webp",
                  title: language === 'pl' ? "Sierra Espuña" : "Sierra Espuña",
                ...
                {
                  src: "/images/places/Castillo de la Atalaya.webp",
                ...
                {
                  src: "/images/places/playas-torrevieja-la-mata.webp",
                ...
                {
                  src: "/images/places/Calle del Mar Santa pola.webp",
                ...
                {
                  src: "/images/places/lake pink.webp",
                ...
                {
                  src: "/images/places/torrevieja flamingos.webp",
                ...
                {
                  src: "/images/places/Lagunas de La Mata y Torrevieja.webp",
                ...
                {
                  src: "/images/places/Castillo de Monteagudo.webp",
                ...
                {
                  src: "/images/places/torrevieja.webp",
                ...
                {
                  src: "/images/places/Playa Albir.webp",
                ...
                {
                  src: "/images/places/Laguna de La Mata.webp",
                ...
                {
                  src: "/images/places/Alicante.webp",
